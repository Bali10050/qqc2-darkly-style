...
class IconLabelLayout : public QQuickItem
{
    ...
    Q_PROPERTY(Darkly::QQuickIcon icon READ icon WRITE setIcon NOTIFY iconChanged FINAL)
...
public:
    ...
    Darkly::QQuickIcon icon() const;
    void setIcon(const Darkly::QQuickIcon &icon);
